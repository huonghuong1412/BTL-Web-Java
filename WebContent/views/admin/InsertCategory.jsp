...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h3 class="bg-banner-title">Thêm danh mục</h3>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="products__page">
		<div class="container">
			<div class="row">
				<form action="<%=request.getContextPath()%>/AddCategoryServlet" method="post">
					<input type="text" placeholder="Thêm danh mục sản phẩm" class="header__main--search-input" name="CategoryName">
